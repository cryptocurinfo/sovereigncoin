...
unlocked to sign the Sovereigncoin-Qt.app bundle.
...
allowing somebody to distribute a Sovereigncoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the sovereigncoin-qt.exe file inside the installer had not been tampered with.
